...
| Playable evidence clips | Canvas jumps to source time, but no query-created bounded clip artifact | Make selected moments exportable as review-only clips | P1 | Evidence clip materializer with source hash lineage |
