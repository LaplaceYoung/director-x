...
function requiredPolicyDefinitions(excludedName) {
  const names = [
    ...
    "directorx_get_fast_start_status", "directorx_get_production_status", "directorx_resume_production", "directorx_research_video", "directorx_query_director_knowledge",
