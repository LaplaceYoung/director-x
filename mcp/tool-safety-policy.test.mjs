...
test("classifies reads, runtime mutation, network access, idempotency, and destructive actions", () => {
  ...
  const generationFacade = directorXToolSafetyAnnotations("directorx_generate_media");
...
function requiredPolicyDefinitions(excludedName) {
  const names = [
    ...
    "directorx_get_fast_start_status", "directorx_get_production_status", "directorx_resume_production", "directorx_research_video", "directorx_generate_media", "directorx_query_director_knowledge",
