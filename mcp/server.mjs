...
async function executeTool(name, args) {
  ...
  if (name === "directorx_register_model_pricing") {
    ...
    const record = await inspectArtifact({ ...args, artifactRef: written.artifactRef, path: written.path, stage: current.stage, mediaKind: "document", metadata: { internal: true, owner: "DX-Director", sourceArtifactRefs: ["provider_api_research_receipt.json"], providerId: evidence.providerId, modelId: evidence.modelId } });
