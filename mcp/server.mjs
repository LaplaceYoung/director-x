...
const rawTools = [
  ...
  },
  {
    ...
    description: "Validate one provider/model/mode choice and return its friendly key setup, official docs, capability limits, polling interval, and current-session credential readiness without exposing a secret.",
