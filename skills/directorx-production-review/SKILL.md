...
9. Use the canvas A/B inspector to synchronize the source and repaired candidates and jump to durable defect/evidence timecodes. Treat it as inspection only; production selection remains `directorx_select_generation_candidate` and final approval remains in Codex.
